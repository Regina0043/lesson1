...
*/
let nameCity = "Санкт - Петербург";
let country = "Россия";
let populationSize = 4991000;
let footballStudium = true;
...
if (footballStudium === true){
    console.log("- Есть ли футбольный стадион" + " (" +"да" + ")");
}

else{
    console.log("- Есть ли футбольный стадион" + " (" +"нет" + ")");
}
